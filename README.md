...
<body>
  ...
  <script>
    ...
    music.addEventListener("ended", () => {
      ...
      floating.textContent = "🎂 สุขสันต์วันเกิด พี่อ้วน! สุขสันต์วันเกิดพี่ชายที่รัก ขอให้พี่ได้รับแต่ความรักและความอบอุ่นจากคนรอบข้าง ไปไหนมาไหนมีแต่คนรัก ปราศจากโรคภัยไข้เจ็บ 🎉";
